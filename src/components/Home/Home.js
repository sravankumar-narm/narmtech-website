...
import settings1 from "../../Images/home/settings1.png";
import settings2 from "../../Images/home/settings2.png";
import password from "../../Images/home/Password.png";
import password2 from "../../Images/home/Chart.png";
import password3 from "../../Images/home/Password2.png";
...
import I from "../../Images/home/I.png";
    ...
    <div className="home">
      ...
      <div className="icon6" alt="" src="./public/icon.svg">
        ...
        <div className="dashboard">
          ...
          <img className="dash28" src={line} />
        </div>
        <div className="password3">
          <div className="pass"></div>
          <img className="Rect1" src={password2} />
          <img className="Rect2" src={password3} />
        </div>
      </div>
      <img className="navigation-icon" alt="" src={Navigation} />
      ...
      <div className="content-wrapper">
        <div className="content2">
          ...
          <div className="rating">
            <img className="rating-child" alt="" src={star} />
            <img className="rating-child" alt="" src={star} />
            <img className="rating-child" alt="" src={star} />
            <img className="rating-child" alt="" src={star} />
            <img className="rating-child" alt="" src={star} />
